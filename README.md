...
_A very generic and powerful data driven coding and testing framework. A whole new paradigm enabling true data driven programming. [Try Live Fiddle](http://www.cuframework.org/cufiddle)._

_<<<<<<TBD: Document to be updated with details of Namespaces, Functions, EL, Config Manager and Serializers.>>>>>>_
<br><br>
